        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="body">
                            <form class="form-horizontal" action="{{ route('admin.save.lost')}}" method="POST">
                                @csrf
                                <div class="row clearfix">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="document_type">
                                                ...
                                                @foreach ($types as $type)
                                                    <option value="{{$type->id}}" {{(old('document_type')==$type->id)?'checked':''}}>
                                                        {{$type->type}}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-8 offset-sm-2">
                                        <button type="submit" class="btn btn-raised btn-primary btn-round waves-effect" id="send">Report Lost Document</button>
                                    </div>
                                </div>
                            </form>
                        </div>
