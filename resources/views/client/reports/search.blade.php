        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="body">
                            <form action="{{ route('client.document.search')}}" method="get">
                            ...
                            <tbody>@foreach ($results as $item)
                                <tr>
                                    <td class="max_ellipsis">
                                        <h5 class=""><a href="{{ route('client.myfound.document',Crypt::encryptString($item->id))}}" style="color: #1272BA"><strong>{{$query}}</strong> Search result!</a></h5>
                                        <a class="link" href="{{ route('client.myfound.document',Crypt::encryptString($item->id))}}" style="color:#5CC2D6">
                                            {{$type->type}} : {{substr_replace($item->document_number,'*********',6)}}{{substr($item->document_number,-2)}}
